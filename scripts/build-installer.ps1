...
# Salida: installer\FullTechnology_Setup_v3.1.exe
$ErrorActionPreference = 'Stop'

$root = Split-Path -Parent $PSScriptRoot

Write-Host "============================================" -ForegroundColor Cyan
Write-Host " FULLTECHNOLOGY v3.1 (Avalonia) - Instalador" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
Write-Host "Ubicación: installer\FullTechnology_Setup_v3.1.exe" -ForegroundColor Green
Write-Host ""
Write-Host "Para distribuir: envía el archivo FullTechnology_Setup_v3.1.exe" -ForegroundColor Cyan
